type TCurrency = "BYN" | "USD" | "EUR" | "RUB";
type TLanguage = "russian" | "english";

/**
 * @see docs https://docs.webpay.by/#POSTRequest */
export interface IFormPayFields {
  /**
   ...
   * - При оплате через ЕРИП значение поля не может начинаться на 0 (ноль). */
   ...
   * @see docs https://docs.webpay.by/#orderSignature */
  wsb_seed: string;
   ...
   * @see docs https://docs.webpay.by/#paymentAlert */
...
/**
 * @see docs https://docs.webpay.by/#cartFields */
export interface IFormCartFields {}
